        ...
        <div id="main-wrapper">
                ...
                <div className="container">
                    <div className="mwt-content">
                        ...
                        <div id="xsearch" className="home-search">
                            ...
                            <div className="description text-center mb-3">9anime.to - Just a better place to watch anime
                                online
                                for free!
                            </div>

                            <div className="mw-buttons text-center">
                                <div className="block mb-2"><a target="_blank" href="https://twitter.com/9Animevc"
            ...
            <div id="mw-text">
                <div className="container">
                    ...
                    <h2 className="mt-h-medium">What's the new website of 9anime? Which 9anime is real?</h2>
                    <p>9anime.vc is currently the only official website of 9anime so please be aware of fake sites. The
                        original 9anime.to (9anime to official) was filled with ads and that's why we built the new
                    ...
                    <h2 className="mt-h-medium">Is there a 9anime app?</h2>
                    ...
                    <h2 className="mt-h-medium">9anime is blocked by my ISP, how to get 9anime unblocked?</h2>
                    ...
                    <h2 className="mt-h-medium">Is 9anime no ads guaranteed?</h2>
                    <p>Yes, as you can see the official 9anime.vc website currently comes with no Ads.</p>
